...
///  • Блок из уведомления = hosts-блок ДОМЕНА, и только если удалось честно получить имя хоста (PTR).
...
///
/// И наблюдение, и блокировка домена доступны без лицензии. Множество «виданных»
